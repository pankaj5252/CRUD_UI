    ...
    <>
      <section className="py-3 py-md-5">
        <div className="container">
          <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center m-0">
              ...
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  <Zoom direction="right">
                    ...
                    <p className="lead fs-4 text-danger mb-3">
                    ...
                    <p className="mb-5">
                      We are a fast-growing company, but we have never lost
                      sight of our core values. We believe in collaboration,
                      innovation, and customer satisfaction. We are always
